...
The form module contains a form component that uses Angular reactive forms to build a form dynamically according to inputs from the user. 

The form module also has a form validation service that takes care of the validation. This is used in the form component.

To use the form module, import `MidgardFormModule` into your Angular module and then: 
...
formFields = [
    ...
    {label: 'Email', controlName: 'email', type: 'text', validators: ['required', 'email'] }
];
```
...
<mg-form
    [selector]="selector"
    [loadAction]="'LOAD_AUTHUSER'"
    [updateAction]="'UPDATE_AUTHUSER'"
    [createAction]="'CREATE_AUTHUSER'"
    [editButtonText]="'Edit Profile'"
    [formFields]="userProfileFormFields"
    (formSubmitted)="onFormSubmitted($event)"
    [updateMessage]="'your user profile has been updated'">
</mg-form>
```
 -->
### Translation module
