...
export class SearchBarComponent implements OnInit {
  public searchInputStyles = {
    width: '300px', borderBottomRightRadius: '0', borderTopRightRadius: '0', marginTop: 0, borderRight: 0,
  };

  public searchButtonStyles = {
    borderBottomLeftRadius: '0', borderTopLeftRadius: '0', borderLeft: '0', padding: '11px',
  };
